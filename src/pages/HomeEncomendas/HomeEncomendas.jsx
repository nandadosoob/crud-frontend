...
export function HomeEncomendas() {
  ...
  const [criaPedido, setCriaPedido] = useState(false);

  const adicionaCriaPedido = () => {
    ...
    <Pagina>
      ...
      <div className="min-h-screen bg-gray-200 py-8 px-6">
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <div className="text-gray-700 border-b border-gray-200 hover:bg-gray-100 flex justify-evenly">
